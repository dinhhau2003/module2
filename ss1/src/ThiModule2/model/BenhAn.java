...
public abstract class BenhAn {
    ...
    public BenhAn(int soThuTu, int maBenhAn, String maBenhNhan, String tenBenhNhan, String ngayNhapVien, String ngayRaVien, String lyDoNhapVien) {
    ...
    public abstract String getToCSV();
}
